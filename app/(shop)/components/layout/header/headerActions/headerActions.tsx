...
import { Search, UserRound, ShoppingBasket } from 'lucide-react';
    ...
    return (
        <div className="relative w-full flex justify-end items-center px-2">
            ...
            <div className="group w-[35px] h-[35px] flex justify-center items-center hover:cursor-pointer">
                ...
                <form className="absolute top-full right-0 z-10 w-[250px] p-3 bg-white border border-gray-500 rounded
